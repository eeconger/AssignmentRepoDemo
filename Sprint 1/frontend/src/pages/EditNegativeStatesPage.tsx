...
const EditNegativeStatesPage: React.FC = () => {
  const { token } = useAuth();
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        setSelectedStates(profile.negativeStates || []);
      } catch (error) {
...
export default EditNegativeStatesPage;

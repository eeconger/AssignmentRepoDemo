      ...
      <div className="flex flex-col items-center w-full max-w-2xl mx-4 p-8 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="w-full text-gray-700 space-y-4">
          <section>
            ...
            <p>
              By creating an account and using our application, you agree to be
          ...
          <section>
            ...
            <p>
              ...
              including habits and states of being, will be stored securely and
              used only to provide you with personalized insights.
            </p>
          </section>

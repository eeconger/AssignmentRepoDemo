...
const EditPositiveHabitsPage: React.FC = () => {
  const { token } = useAuth();
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        setSelectedHabits(profile.positiveHabits || []);
      } catch (error) {
...
export default EditPositiveHabitsPage;
